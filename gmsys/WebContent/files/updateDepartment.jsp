...
<body data-type="index">
	...
	<div class="tpl-page-container tpl-page-header-fixed">
		...
		<div class="tpl-content-wrapper">
			<form
				action="${pageContext.request.contextPath}/department/update.do"
									...
									<TR>
									  ...
									  %>
														...
														<td width="35%"><input name='departid' type="text"
															...
															value="<%=department.getDepartid() %>" /> <span
															class="red">*</span></td>
														<td nowrap align="right" width="15%">部门名称:</td>
														<td width="35%"><input name='departname' type="text"
															class="text" style="width: 154px"
															value="<%=department.getDepartname() %>" />
															<td nowrap align="right" width="15%">所属区域:</td>
															<td width="35%"><select name="areaname">
