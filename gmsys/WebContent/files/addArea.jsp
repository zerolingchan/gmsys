...
<%--内容 --%>
        <div class="tpl-content-wrapper">
            <form action="${pageContext.request.contextPath}/area/add.do" method="post" name="form"  >
				<div class="MainDiv">
				<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
				  <tr>
				      <th class="tablestyle_title" >区域信息录入</th>
				  </tr>
				  <tr>
				    <td class="CPanel">
							...
							<TD width="100%">
								...
								<legend>地区信息</legend>
									 ...
									 <tr>
									    ...
									    <td nowrap align="right" width="15%">地区编号:</td>
									    <td width="35%"><input name='areaid' type="text" class="text" style="width:154px" value="" />
								    
									  </tr>
									  <tr>
									 
									    <td nowrap align="right" width="15%">地区名称:</td>
									    <td width="35%"><input name='areaname' type="text" class="text" style="width:154px" value="" />
								    
									  </tr>
									  <tr>
									 
									    <td nowrap align="right" width="15%">地区关系:</td>
									    <td width="35%"><input name='relative' type="text" class="text" style="width:154px" value="" />
