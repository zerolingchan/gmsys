...
<body data-type="index">
	...
	<div class="tpl-page-container tpl-page-header-fixed">
		...
		<div class="tpl-content-wrapper">
			<form action="${pageContext.request.contextPath}/provider/update.do"
				              	...
				              	%>
													...
													<tr>
														...
														<td width="35%"><input name="provid" type="text"
															...
															value="<%=b.getProvid() %>" /> <span class="red">*</span></td>
														<td nowrap align="right" width="15%">供应商名称:</td>
														<td width="35%"><input name="provname" type="text"
															class="text" style="width: 154px"
															value="<%=b.getProvname() %>" />
													</tr>
													<tr>
														<td nowrap align="right" width="15%">联系电话:</td>
														<td width="35%"><input name="phone" type="text"
															class="text" style="width: 154px"
															value="<%=b.getPhone() %>" />
